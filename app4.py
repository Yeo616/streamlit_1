...
def main():
    ...
    # 버튼 만들기
    # 버튼을 누르면/마우스로 클릭하면 버튼이 True가 된다.
    # st.button('데이터 보기')
    ...
    # '대문자' 버튼을 만들고, 버튼을 누르면, species 컬럼의 값들을 대문자로 변경한
    # 데이터 프레임을 보여주세요.
    if st.button('대문자'):
...
#    st.selectbox('좋아하는 언어 선택',language)
    ...
    # 슬라이더: 숫자 조정하는데 주로 사용
    # st.slider('나이',1,120,30,5)
    # st.slider(화면에 어떻게 보여질것이냐, 최소값, 최대값, defult 값, 슬라이더 사용하는 데 몇 단위씩)
